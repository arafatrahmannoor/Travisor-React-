    ...
    return (
        <div>
            <Helmet>
                ...
                <meta name="description" content="Explore the beauty of Cox's Bazar, the longest natural sea beach in the world." />
            </Helmet>
                ...
                <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-2/3">
                        <div className="w-full h-[500px] mb-6">
                            <img src="../img/attraction/cox.png" alt="Cox's Bazar" className="w-full h-full object-cover rounded-xl" />
                        </div>
                        <h4 className="text-2xl font-bold mb-4">COX'S BAZAR THE LARGEST SEABEACH IN THE WORLD</h4>
